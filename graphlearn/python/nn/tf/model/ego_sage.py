...
class EgoGraphSAGE(Module):
  """ GraphSAGE. https://arxiv.org/abs/1706.02216.

  Args:
    layers: A list, each element is an `EgoSAGELayerGroup`.
  ...
  def __init__(self,
               ...
               dropout=None,
               **kwargs):
    super(EgoGraphSAGE, self).__init__()
  ...
  def forward(self, graph):
    """ Compute node embeddings through the SAGE layers.
...
class HomoEgoGraphSAGE(EgoGraphSAGE):
  def __init__(self,
               dims,
               agg_type="mean",
               com_type="add",
    ...
    super(HomoEgoGraphSAGE, self).__init__(layers, bn_fn, active_fn, dropout)
