...
class EgoGCN(tfg.Module):
  def __init__(self,
    ...
    for i in range(num_layers):
      ...
      conv = tfg.EgoGCNConv("gcn_" + str(i),
                             in_dim,
                             h_dim,
                             num_bases=num_bases,
  ...
  def forward(self, x_list, expands):
    ...
    Args:
      x_list: A list of list, representing input nodes and their K-hop neighbors.
        ...
        The following element x_list[i] (i > 0) is i-th hop neighbors list.
        ...
        For example, their 2-hop neighbors, the x_list is stored
