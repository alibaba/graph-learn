...
io::GraphStorage* CreateGraphStorage(const std::string& type, const std::string& view_type);
io::NodeStorage* CreateNodeStorage(const std::string& type, const std::string& view_type);
