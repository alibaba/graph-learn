...
RandomWithoutReplacementSamplerActor::RandomWithoutReplacementSamplerActor(
    ...
    : StatelessBaseOperatorActor(exec_ctx, addr, "RandomWithoutReplacementSampler") {
...
OpRefRegistration<RandomWithoutReplacementSamplerActorRef>
  _RandomWithoutReplacementSamplerActorRef("RandomWithoutReplacementSampler");
