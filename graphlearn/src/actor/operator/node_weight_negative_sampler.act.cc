...
#include "actor/operator/node_weight_negative_sampler.act.h"
...
NodeWeightNegativeSamplerActor::NodeWeightNegativeSamplerActor(
    brane::actor_base *exec_ctx,
    const brane::byte_t *addr, const void* params)
    : StatelessBaseOperatorActor(exec_ctx, addr, "NodeWeightNegativeSampler") {
...
NodeWeightNegativeSamplerActor::Process(TensorMap&& tensors) {
  // create request
...
OpRefRegistration<NodeWeightNegativeSamplerActorRef>
  _NodeWeightNegativeSamplerActorRef("NodeWeightNegativeSampler");
