...
def train(args, graph):
  ...
  trainer = tfg.Trainer(
    optimizer=tf.contrib.opt.AdamWOptimizer(weight_decay=args.weight_decay,
...
if __name__ == "__main__":
  ...
  argparser.add_argument('--neighs_num', type=list, default=[5, 2])
