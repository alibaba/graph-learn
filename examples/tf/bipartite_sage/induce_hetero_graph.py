...
# =============================================================================
"""Functions of inducing HeteroSubGraph with target edge."""
import numpy as np

from graphlearn.python.nn.data import Data
from graphlearn.python.nn.hetero_subgraph import HeteroSubGraph

def induce_hetero_graph(src_nodes, dst_nodes, src_nbrs, dst_nbrs):
  ...
  """
  subgraphs = []
  u_data_list, ui_edge_index_list = induce_each_edge_type(src_nodes, src_nbrs, dst_nbrs)
  i_data_list, iu_edge_index_list = induce_each_edge_type(dst_nodes, dst_nbrs, src_nbrs)
...
def induce_each_edge_type(src_nodes, src_nbrs, dst_nbrs):
  ...
  for i in range (src_nodes.ids.size):
    ...
    ids, int_attrs, float_attrs, string_attrs = \
      concat_node_with_nbr(src_id, int_attr, float_attr, string_attr,
...
def concat_node_with_nbr(src_id, int_attrs, float_attrs, string_attrs,
                          nbr, begin, end):
