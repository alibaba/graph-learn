...
test:so gtest
	...
	$(CXX) $(CXXFLAGS) graphlearn/core/operator/aggregator/test/aggregation_op_unittest.cpp -o built/bin/aggregation_op_unittest $(TEST_FLAG)
	...
	$(CXX) $(CXXFLAGS) graphlearn/service/request/test/aggregation_request_unittest.cpp -o built/bin/aggregation_request_unittest $(TEST_FLAG)
